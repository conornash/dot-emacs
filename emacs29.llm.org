...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (use-package agent-shell
    ...
    (defun agent-shell--get-org-link-at-point ()
      "Get org-link at point formatted for agent-shell insertion.
Returns nil if not in org-mode or no link at point."
...
Relevant text could be files, region, org-link, or error at point."
    ...
    (defun agent-shell-test-org-link-capture ()
      "Test that org-link capture works correctly.
Creates temp org buffers, inserts links, and verifies capture."
      (interactive)
      (let ((test-cases
