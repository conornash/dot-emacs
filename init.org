...
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package rudel
    ...
    (rudel-subscribe
     ...
     global-rudel-mode-line-publish-state-mode rudel-change-color
     rudel-mode-line-publish-state-minor-mode rudel-publish-buffer
     rudel-host-session rudel-backend-dump rudel-minor-menu
     rudel-join-session global-rudel-minor-mode rudel-speedbar
     rudel-unsubscribe rudel-leave-session)
    :config
    (require 'rudel-mode)
    (require 'rudel-obby)
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package floobits
    :commands (floobits-delete-workspace
    floobits-follow-mode-toggle floobits-complete-signup
    floobits-clear-highlights floobits-summon
    floobits-workspace-settings floobits-add-to-workspace
    floobits-open-workspace-in-browser floobits-share-dir-public
    floobits-leave-workspace floobits-share-dir-private
    floobits-join-workspace floobits-debug-output floobits-debug
    floobits-follow-user floobits-remove-from-workspace))
#+END_SRC
