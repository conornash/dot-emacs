...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (use-package exec-path-from-shell
    ...
    (setq exec-path-from-shell-variables
          '("PATH" "MANPATH" "DOCKER_TLS_VERIFY" "DOCKER_HOST" "DOCKER_CERT_PATH" "DOCKER_MACHINE_NAME"))
...
* Smartparens
#+BEGIN_SRC emacs-lisp :tangle yes
;; load last so that it doesn't override other bindings
...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  ;; Visual line mode - is awkward for killing long lines in R
...
* Eshell
#+BEGIN_SRC emacs-lisp :tangle yes
(load (expand-file-name "emacs24.eshell" user-emacs-directory))
...
#+BEGIN_SRC emacs-lisp :tangle yes
;; Shouldn't be global since it can mess up TSV files
