...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (global-set-key (kbd "s-w") #'delete-or-hide-frame)
...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (use-package guide-key
    ...
    :config
    (setq guide-key/guide-key-sequence '("C-x r" "C-x 4" "C-x v" "C-x j" "<C-f1>" "C-;" "C-c" "<f2>" "s-p" "C-c p")
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (add-hook 'sh-mode-hook
            #'(lambda()
                ...
                (define-key shell-mode-map (kbd "s-q") 'bury-buffer)
                ))
...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  ;;         tramp-docker-program "/usr/local/bin/docker"
  ;;         )
  ;;   (require 'tramp-container)
  ;;   (defalias 'tcac 'tramp-cleanup-all-connections)
