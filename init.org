...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (add-to-list 'load-path (expand-file-name "emacswiki/dired+" user-emacs-directory))
  (use-package dired+
    :ensure nil
    :config
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package restclient
    ...
    ;; (use-package restclient-jq :ensure nil)
...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (setq face-font-family-alternatives '(("Monospace" "Inconsolata")
