...
#+begin_src emacs-lisp :tangle yes
  (use-package treesit-parser-manager
    :straight (:host nil :repo "https://codeberg.org/ckruse/treesit-parser-manager" :files ("*.el"))
    ...
    (treesit-parser-manager-grammars
     '(("https://github.com/tree-sitter/tree-sitter-rust"
       ...
       ("https://github.com/serenadeai/tree-sitter-python"
        ("tree-sitter-python"))
...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (setq face-font-family-alternatives '(("Monospace" "Cascadia Code PL" "Inconsolata" "Catrinity" "Consolas" "Catrinity" "Symbola" "Noto Sans" "Noto Sans Symbols" "Noto Sans Egyptian Hieroglyphs")
